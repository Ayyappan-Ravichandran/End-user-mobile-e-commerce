...
<body>
  <section class="forms-section">
       <a href="adminlogin"><button class="adminbutton">Admin..</button></a>
  </section>
  
  <img src="images/icons/footer company.png" class="companylogo">
  <br><br><br>
  <div class="forms">
    <div class="form-wrapper is-active">
      ...
      <form class="form form-login" method="post" action="customervalidate"  >
        <fieldset>
 ...
 <div class="form-wrapper">
      ...
      <form class="form form-signup"  method="post" action="customerregister" >
        <fieldset>
